...
def store_voice_timing_data(voice_timing_data, part, question, answer, timing_result):
    """
    Store timing data for voice mode answers

    Args:
        voice_timing_data: List to append timing data to
